...
CREATE TABLE IF NOT EXISTS `mydb`.`quiz` (
  ...
  INDEX `fk_quiz_category1_idx` (`category_id` ASC) ,
...
ALTER TABLE mydb.feedback
MODIFY feedback_id INT DEFAULT 0;
ALTER TABLE quizquestion MODIFY quizquestion_id INT AUTO_INCREMENT;
